        ...
        <div class="cs_slider">
          ...
          <div class="cs_article"><img src="images/tutorial.png" alt="" />
            <div class="text">
              ...
              </br><a class="jschauen" type="submit" href ="photo.php"><label style="color:#000; cursor:pointer;">Photos</label></a></div>
          </div>
          <!-- End -->
          <div class="cs_article"><img src="images/tutorial.png" alt="" />
            <div class="text">
              ...
              </br><a class="jschauen" type="submit" href ="video.php"><label style="color:#000; cursor:pointer;">Videos</label></a>
            </div>
          </div>
          <!-- End  -->
          </div>
...
foreach ($allebilder as $bild) {
    ...
    <li>
        ...
        <span><h2><?php echo $bildinfo['filename']; ?></h2></span>
    </li>
<?php
	};
 };
...
foreach ($alledateien as $datei) {
	...
	?>
            <div class="galerie">
                ...
                <img src="<?php echo $dateiinfo['dirname']."/".$dateiinfo['basename'];?>" width="140" alt="Vorschau" /></a></br></br> 
            </div>
    		<?php 
			// wenn keine Bildeindung dann normale Liste für Dateien ausgeben
			} else { ?>
            <div class="file">
            	<a href="<?php echo $dateiinfo['dirname']."/".$dateiinfo['basename'];?>">&raquo <?php echo ucfirst($dateiinfo['filename']); ?></a> 
            </div>
            <?php } ?>
<?php
	};
